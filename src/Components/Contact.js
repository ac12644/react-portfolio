...
const Contact = ({ data }) => {
   ...
   console.log(data)
    ...
    const handleClick = (e) => {
       e.preventDefault();
      window.open(`mailto:abhishekchauhan150@gmail.com?subject=${subject}&body=${name}: ${message}`);
    }
            ...
            <div className="eight columns">
               ...
               <form id="contactForm" name="contactForm">
                  ...
                  <div>
						   ...
						   <input  type="email" defaultValue="" size="35" id="contactEmail" name="contactEmail" onChange={e=> setEmail(e.target.value)}/>
                  </div>
                  ...
                  <div>
                     ...
                     <textarea value={message} onChange={e => setMessage(e.target.value)} cols="40" rows="5" id="contactMessage" name="contactMessage"></textarea>
                  </div>
